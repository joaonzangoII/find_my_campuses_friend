...
<div class="row-fluid sortable">
      <div class="box span12">
        <div class="box-header" data-original-title>
          <h2><i class="halflings-icon white user"></i><span class="break"></span>Universities</h2>
          <div class="box-icon">
            ...
            <tbody>
              @foreach($universities as $key => $university)
                <tr class="{{ $key%2==0 ? 'even' : 'odd'}}">
        					...
        					<td class="center ">{{$university->chancellor}}</td>
                  <td class="center ">{{ $university->vice_chancellor }}</td>
                  <td class="center ">{{ $university->slogan }}</td>
                  <td class="center ">{{ count($university->faculties) }}</td>
        					<td class="center ">{{ count($university->students) }}</td>
                  <td class="center ">
                    <a class="btn btn-success" href="{{$university->show_link}}">
                      <i class="halflings-icon white zoom-in"></i>
                    </a>
                    <a class="btn btn-info" href="{{$university->edit_link}}">
                      <i class="halflings-icon white edit"></i>
                    </a>
                  {!!Form::open(['method'=> "DELETE","url" => $university->delete_link,"style"=>"display:inline"]) !!}

...
<div class="row-fluid">
    ...
    @endif
      ...
      {!! Form::open(['method' => 'POST',"class"=>"form-horizontal","url"=> "/users"])!!}
    		<fieldset>
       ...
       {{--    <div class="control-group">
          ...
          <div class="control-group">
            ...
            <div class="controls">
              {!! Form::select('user_type_id',$user_types,null,['class' => 'form-control input-xlarge','data-rel'=>"chosen",'data-placeholder'=>"Select State"]) !!}
            </div>
          </div>

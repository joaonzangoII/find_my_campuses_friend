...
<ul class="breadcrumb">
  ...
  <li><a href="#">SOS Requests</a></li>
</ul>

<div class="row-fluid sortable">
      <div class="box span12">
        <div class="box-header" data-original-title>
          <h2><i class="halflings-icon white user"></i><span class="break"></span>SOS Requests</h2>
          <div class="box-icon">
              ...
              @foreach($sos as $key => $item)
                <tr class="{{ $key%2==0 ? 'even' : 'odd'}}">
                  ...
                  <td class="sorting_1 center">
                    ...
                    <a class="btn btn-info" href="{{$item->edit_link}}">
                      <i class="halflings-icon white edit"></i>
                    </a>
                  {!!Form::open(['method'=> "DELETE","url" => $item->delete_link,"style"=>"display:inline"]) !!}

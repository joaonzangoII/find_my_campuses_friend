 ...
 * @see <a href="http://bradfrostweb.com/blog/post/float-label-pattern/">Brad Frost's blog post</a>
 */
public class FloatingLabel extends LinearLayout {
    ...
    public FloatingLabel(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FloatingLabel(Context context, AttributeSet attrs, int defStyle) {
